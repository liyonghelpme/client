...
["chat_empty", "Your contents can't be empty"], ["chat_wordlimit", "word number > 30"], ["chat_nettimeout", "Could not connect to the game server. Please try again later."], 

["text_wordlimit_format", "Limit [NUM] words!"], ["text_cannotset", "Can't change this name!"], ["text_nettimeout", "Could not connect to the game server. Please try again later."], 

["text_message_send", "Please input message: "], ["text_empty", "can't empty"], ["text_chat_nettimeout", "Could not connect to the game server. Please try again later."], 

["message_send_success", "Successfully sent"], ["text_empire_name", "Please input empire name: "], 

["update_normal", "Ordinary"], ["update_caesars", "Fast"], ["update_warning", "The building is occupied. Upgrading will interrupt the operation, are you sure?"], 
...
["resource_get_format", "This fortress produces [MONEY] coins, [FOOD] foods, [WOOD] woods, [STONE] stones per hour. Time left to harvest [TIME]"], 
["quit", "Quit"], ["back", "Back"], 
...
["attackIs", "ATK : "], 
["powerlack", "You don't have enough fight powers!"], 
["monRob", "Monsters have robbed [FOOD] crops"], 
["active", "Active"], 
["activeDra", "would you help me activate it?"], 
...
["colonial", "colonial "], 
["levelUp", "Congrats! [NAME] has upgraded to lev [LEVEL], come on to build your own miracle empire!"], 
["goInNewMap", ", you will find more powerful players in higher level map."], 
...
["BusiCard", "[WHO] have to reach [NUM] to upgrade your [TYPE] to the next level. Your magic capacity will increase by 1 when you level up!"], 
...
["FriendCard1", "You need [NUM] more friends to get [NAME] [LEV]. Your magic capacity will increase by 1 at each level."], 

["FriendCard2", "You need to open [NUM] more treasure chest for your friends to get [NAME] [LEV]. Your magic capacity will increase by 1 at each level."], 
["FriendCard3", "You need to feed your friends' dragons [NUM] more times to get [NAME] [LEV]. Your magic capacity will increase by 1 at each level."], 
["FriendCard4", "You need to reach level [NUM] to get [NAME] [LEV]. Your magic capacity will increase by 1 at each level."], 
["FriendCard5", "You can use one-step visiting from now on!"], 
["MonsterZijin", "Your magic capacity will increase by 2 when get violet card."], 
["ChangEZijin", "Your magic capacity will increase by 1 when card level up."], 
["PlantZijin", "Your magic capacity will increase by 1 when card level up."], 
["BusiZijin", "Your magic capacity will increase by 1 when card level up."], 
...
dict([["req", "attack"], ["des", ["Attack enemy", "Defeating enemies will bring you more money, glory, and fame!", "attack enemy"]], ["checknum", 1], ["pair", []], ["reward", [1000, 10, 0]], ["type", 0], ["id", 7]]), 
...
dict([["req", "dialog-nobility"], ["des", ["Upgrade nobility ranking", "Higher nobility will allow you have more rights", "upgrade nobility"]], ["checknum", 1], ["pair", []], ["reward", [2000, 25, 0]], ["type", 2], ["id", 9]]), 
