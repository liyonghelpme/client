class Petstate4 extends ContextObject{
    ...
    function closedialog(n,e,p){
        ...
        if(p!=null){
            ...
            if(build.state==4){
                ppy_postnewsfeed(global.getFormatString("share_format",["[NAME]",ppy_username(),"[DESCRIBE]",global.getStaticString("share_getup_1")]),ShareURL);
            }
            else{
                ppy_postnewsfeed(global.getFormatString("share_format",["[NAME]",ppy_username(),"[DESCRIBE]",global.getStaticString("share_getup_2")]),ShareURL);
            }
        }
    }
