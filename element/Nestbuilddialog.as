class Nestbuilddialog extends ContextObject{
    ...
    function paintNode(){
        ...
        if(mode == 1){
            head.addlabel(global.getStaticString("activeDra"),null,20).pos(103,19).color(0,0,0,100);
    ...
    function askforhelp(){
        ...
        ppy_postnewsfeed(ppy_username()+global.getStaticString("getDragon"),"http://getmugua.com");
    }
...
trace("helpopen",rc,c);
    ...
    function closedialog(node,event,p){
        ...
        if(p==1){
            ...
            ppy_postnewsfeed(global.getFormatString("dragonPost", "[NAME]", ppu_username()),"http://getmugua.com");
        }
    }
