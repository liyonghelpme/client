class Nestbuilddialog extends ContextObject{
    ...
    function askforhelp(){
        ...
        ppy_postnewsfeed(ppy_username()+"获得了能召唤宠物的龙巢，但是需要你们的帮助才能打开，快去帮助它吧！", ShareURL, null);
    }
...
trace("helpopen",rc,c);
    ...
    function closedialog(node,event,p){
        ...
        if(p==1){
            ...
            ppy_postnewsfeed(ppy_username()+"成功地激活了他的龙巢，赶快加入与"+ppy_username()+"一起打造属于自己的奇迹帝国吧！", ShareURL, null);
        }
    }
