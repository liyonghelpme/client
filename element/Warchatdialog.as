class Warchatdialog{
    ...
    function getNode(){
        ...
        //v_root().addview(web);
        pid=http_request("http://223.4.85.114:8004/recv?uid="+str(uid)+"&cid="+str(cid)+"&since="+str(lasttime),additems);
        return contextNode;
    }
    ...
    function send(){
        ...
        if(t==""){
            ...
            web.text("");
            http_request("http://223.4.85.114:8004/send?uid="+str(uid)+"&name="+uri_encode(name)+"&cid="+str(cid)+"&text="+st,sendover);
        }
    }
