class Activitydialog extends ContextObject{
    ...
    function paintNode(){
        ...
        contextNode.addlabel(global.getStaticString("goSee"),null,BUTTONFONTSIZE).anchor(50,50).pos(257,400);
        contextNode.addsprite("boxbutton2.png").anchor(50,50).pos(417,400).setevent(EVENT_TOUCH,closedialog,null);
        contextNode.addlabel(global.getStaticString("IKnow"),null,BUTTONFONTSIZE).anchor(50,50).pos(417,400);
    }
