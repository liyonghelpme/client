class WoodControl extends ContextObject{
    var objs;
    var left;
    var right;
    var pagemax;
    ...
    const PAGEITEMS = 6;
    var objlevel;
    function WoodControl(){
        contextname = "dialog-object-wood";
        contextNode = null;
        objs = new Array(0);
    ...
    function initdata(){
        pagemax = 1;
        objmax = 6;
        objlevel = [10,14,12,21,28,25];
        titlename = global.getStaticString("chooseWood");
        objpath="wood";
    }
    ...
    function getcell(i){
        ...
        if(objlevel[i] > global.user.getValue("level")){
            ...
            cell.addlabel(global.gettimestr(WOOD_TIME[i]),null,20).anchor(100,50).pos(171,125).color(0,0,0,100);
            cell.addsprite("wood.png").size(33,24).anchor(0,50).pos(11,155);
            cell.addlabel(str(WOOD_GAIN[i]),null,20).anchor(0,50).pos(44,155).color(0,0,0,100);
            cell.addsprite("exp.png").size(42,21).anchor(0,50).pos(110,155);
            cell.addlabel(str(WOOD_EXP[i]),null,20).anchor(0,50).pos(154,155).color(0,0,0,100);
        }
        return cell;
    }
