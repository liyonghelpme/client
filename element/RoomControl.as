class RoomControl extends ContextObject{
    ...
    //设置方法， 可以根据编号动态设定
    const objlevel = 
    [1, 1, 1, 1, 3, 3, 3, 5, 5, 5, 5, 8, 8, 8, 8, 10, 10, 10, 10, 15, 15, 15, 15, 20, 20, 20, 20];
    ...
    */
    const objcontext = 
    [2100, 2103, 2106, 2109, 2178, 3172, 3175, 2112, 2115, 2118, 2121, 2160, 2163, 2166, 2169, 2124, 2127, 2130, 2133, 3136, 3139, 3142, 3145, 3148, 3151, 3154, 3157];
    /*
    [
    2178,
