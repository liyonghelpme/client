            ...
            if(placeObj.buildcontextname!="nest"){
                ...
                if(place.state == BUILDING || place.state == WORKING){
                    ...
                    if(place.state == WORKING){
                        if(mode == ROOM_INDEX) labelstr = global.getStaticString("inCall");
                        else if(mode == FACT_INDEX) labelstr = global.getStaticString("inProduct");
                        else if(mode == CAMP_INDEX) labelstr = global.getStaticString("training");
