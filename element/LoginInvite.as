class LoginInvite extends ContextObject{
    ...
    function paintNode(){
        ...
        showlabel = contextNode.addlabel(global.getFormatString("inviteNotice", ["[CODE]", str(global.user.inviteCode)]),null,20,FONT_BOLD,308,0,ALIGN_LEFT).anchor(0,50).pos(100,130).color(0,0,0,100);
        var WIDTH = 190;
        var HEIGHT = 38;
        var but0 = contextNode.addsprite("boxbutton1.png").anchor(50,50).pos(150,254).size(WIDTH, HEIGHT).setevent(EVENT_UNTOUCH, writeCode);
