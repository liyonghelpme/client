class ObjControl extends ContextObject{
    ...
    var flagmove;
    const objsmax = 53;
    const objlevel = [27,30,32,34,37,40,17,17,20,2,2,2,3,3,3,4,5,6,6,6,6,6,6,7,8,9,10,10,11,12,13,14,15,15,15,15,15,16,16,16,18,18,18,18,19,19,19,19,25,25,25,30,40];
    const objcontext = [2600,2601,2602,2603,2604,2605, 1545, 1546, 1542,1543,2544,1500,1501,1502,2539,2540,2541,1503,1504,1505,1506,1507,1508,1509,1510,1511,1512,1513,1514,1515,1520,1516,1517,1518,1519,1528,1529,1530,1531,1521,1522,1523,1524,1525,1526,1527,1532,1533,1534,1538,1535,1536,1537];
    function ObjControl(){
        contextname = "element-build-object";
        contextNode = null;
        objs = new Array(53);
        buildable = new Array(53);
