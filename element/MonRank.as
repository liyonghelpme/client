class MonRank extends ContextObject{
    var nameNode;
    function MonRank(){
    ...
    function showData(data)
    {
        ...
        if(myrank >= 1000)
            nameNode.addlabel("999+", null, 30).anchor(0, 50).pos(263, 54).color(0, 0, 0, 100);
        else
            nameNode.addlabel(str(myrank), null, 30).anchor(0, 50).pos(263, 54).color(0, 0, 0, 100);
        nameNode.addlabel(str(food), null, 30).anchor(0, 50).pos(608, 54).color(0, 0, 0, 100);
    }
