class Nobilitydialog extends ContextObject{
    ...
    function excute(p){
        ...
        if(p==1){
            ...
            ppy_postnewsfeed(global.getFormatString(7+global.user.getValue("nobility")%3,["[USERNAME]",ppy_username(),"[NOBNAME]",NOBNAME[global.user.getValue("nobility")]]), ShareURL, null);
        }
    }
}
