class UpnewsControl extends ContextObject{
    ...
    function UpnewsControl(){
        ...
        lock=0;
        items = [
        "2011/12/13 魔法值上线啦！+大家好！魔法值上线啦！加速，一键，神迹，保护等功能都可以通过魔法值施展。魔法值每5分钟回复1点。有建议欢迎在圈子内反馈哦！",
        "2011/11/15 兽神神像上线啦！+兽神神像施展神迹期间，所有怪兽雕像都会增加城堡防御力哦！注：神迹施展之后建造的雕像无效，即神迹只对已经建造完成的雕像有效",
